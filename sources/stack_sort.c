#include "../includes/stack_sort.h"
#include "../includes/stack_insertion_sort.h"
#include "../includes/stack_split.h"
#include "../includes/sort_utils.h"
#include "../includes/stack_sort3.h"
...
void stack_sort5(two_stacks_t *two_stacks)
{
	...
	{
		stack_sort3(two_stacks, two_stacks->a.stackVals, STACK_A, DESCENDING_ORDER);
		if (two_stacks->b.stackVals[0] > two_stacks->b.stackVals[1])
			two_stacks_command(two_stacks, CMD_SB);
	}
	else
	{
		stack_sort3(two_stacks, two_stacks->b.stackVals, STACK_B, ASCENDING_ORDER);
